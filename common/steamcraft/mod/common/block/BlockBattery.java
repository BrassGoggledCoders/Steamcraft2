 ...
 *
 */
public class BlockBattery extends BlockSC2
{
	...
	public void registerIcons(IconRegister icon) {
		this.blockIcon = icon.registerIcon(SC2_Info.SC2_PREFIX + "batteryside");
		this.batteryIconTop = icon.registerIcon(SC2_Info.SC2_PREFIX + "batterytop");
	}

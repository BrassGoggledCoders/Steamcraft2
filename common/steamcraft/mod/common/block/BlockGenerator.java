...
import common.steamcraft.mod.client.lib.SC2_GuiIDs;
...
public class BlockGenerator extends BlockSC2Container
{
	...
	{
		blockIcon = par1IconRegister.registerIcon(SC2_Info.SC2_PREFIX + "generatorside");
		iconFront = par1IconRegister.registerIcon(SC2_Info.SC2_PREFIX + "generatorfrontinactive");
		iconFrontA = par1IconRegister.registerIcon(SC2_Info.SC2_PREFIX + "generatorfrontinactive");
		iconTop = par1IconRegister.registerIcon(SC2_Info.SC2_PREFIX + "generatortop");
	}
			...
			float par9)
	{
		...
		else
		{
			...
			if (tile_entity == null || par5EntityPlayer.isSneaking())
				return false;
			par5EntityPlayer.openGui(SC2.instance, SC2_GuiIDs.GUI_ID_GENERATOR, par1World, par2, par3, par4);
			return true;
		}
	}

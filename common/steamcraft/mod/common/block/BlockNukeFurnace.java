...
public class BlockNukeFurnace extends BlockSC2Container
{
	...
	{
		this.blockIcon = icon.registerIcon(SC2_Info.SC2_PREFIX + "nukefurnaceside");
		this.furnaceIconFront = icon.registerIcon(this.isActive ? SC2_Info.SC2_PREFIX + "nukefurnacefronton" : SC2_Info.SC2_PREFIX + "nukefurnacefrontoff");
		this.furnaceIconTop = icon.registerIcon(SC2_Info.SC2_PREFIX + "nukefurnacetop");
	}

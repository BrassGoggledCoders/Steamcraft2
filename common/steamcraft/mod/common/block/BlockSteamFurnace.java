...
public class BlockSteamFurnace extends BlockContainer
{
	...
	{
		this.blockIcon = icon.registerIcon(SC2_Info.SC2_PREFIX + "steamfurnaceside");
		this.furnaceIconFront = icon.registerIcon(this.isActive ? SC2_Info.SC2_PREFIX + "steamfurnacefronton" : SC2_Info.SC2_PREFIX + "steamfurnacefrontoff");
		this.furnaceIconTop = icon.registerIcon(SC2_Info.SC2_PREFIX + "steamfurnacetop");
	}

...
public class BlockChemicalFurnace extends BlockSC2Container
{
	...
	{
		this.blockIcon = icon.registerIcon(SC2_Info.SC2_PREFIX + "chemfurnaceside");
		this.furnaceIconFront = icon.registerIcon(this.isActive ? SC2_Info.SC2_PREFIX + "chemfurnacefronton" : SC2_Info.SC2_PREFIX + "chemfurnacefrontoff");
		this.furnaceIconTop = icon.registerIcon(SC2_Info.SC2_PREFIX + "castironblock");
	}

 ...
 *
 */
public class SC2_RecipeHandlerCompressor
{
    private static final SC2_RecipeHandlerCompressor recipeBase = new SC2_RecipeHandlerCompressor();
     ...
     */
    public static final SC2_RecipeHandlerCompressor recipe()
    {
        return recipeBase;
    }

    private SC2_RecipeHandlerCompressor()
    {
    	// Compressor

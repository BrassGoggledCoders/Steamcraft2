 ...
 *
 */
public class ItemSC2Electric extends ItemSC2 implements IEnergizedItem, IItemElectric, ISpecialElectricItem, IEnergyContainerItem {
	public int MAX_ELECTRICITY;
	public int VOLTAGE;
	public static double ENERGY_PER_REDSTONE = 10000.0D;	
	int toolTier;

	public ItemSC2Electric(int id, int maxEnergy, int voltage, int tier) {
		super(id);
	...
	public int getMaxCharge(ItemStack itemStack) {
		return (int) (this.getEnergy(itemStack)*SC2_CompatibilityChecker.UE_TO_IC2);
	}

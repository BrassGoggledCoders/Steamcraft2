 ...
 *
 * File created @ [2 Mar 2014, 21:39:21]
 */
 ...
 * 2 Mar 201421:39:21
 */
//TODO: make this a multiblock structure
public class BlockDropHammer extends BlockContainerMod
{
	...
	public BlockDropHammer(int par1)
	{
	...
	{
		blockIcon = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "hammerside");
		iconFront = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "hammerfrontinactive");
		iconFrontA = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "hammerfront");
		iconTop = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "hammertop");
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
	{
		if (!keepInventory)
		{
			TileEntityDropHammer var7 = (TileEntityDropHammer) par1World.getBlockTileEntity(par2, par3, par4);

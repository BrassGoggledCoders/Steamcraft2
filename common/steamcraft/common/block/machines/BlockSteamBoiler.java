...
public class BlockSteamBoiler extends BlockContainerMod
{
	...
	{
		blockIcon = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "generatorside");
		iconFront = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "generatorfrontinactive");
		iconFrontA = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "generatorfrontinactive");
		iconTop = par1IconRegister.registerIcon(LibInfo.SC2_PREFIX + "generatortop");
	}

...
import common.steamcraft.api.vanity.ILeggings;
...
{
public SlotLeggings(IInventory inventory, int par2, int par3, int par4)
{
...
return itemstack.getItem() instanceof ILeggings;
}
/**

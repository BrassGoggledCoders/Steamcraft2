 ...
 *
 * File created @ [3 Mar 2014, 07:12:23]
 */
...
{
private static final int ARMOR_START = PlayerInventoryVanity.INV_SIZE, ARMOR_END = ARMOR_START+3,
INV_START = ARMOR_END+1, INV_END = INV_START+26, HOTBAR_START = INV_END+1,
HOTBAR_END = HOTBAR_START+8;

public ContainerVanity(EntityPlayer player, InventoryPlayer inventoryPlayer, PlayerInventoryVanity inventoryCustom)
{
int i;
//Custom Slots

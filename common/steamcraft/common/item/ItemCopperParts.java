...
public class ItemCopperParts extends ItemMod {
    ...
    public ItemCopperParts(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("partsCopper");
    }
	...
	return super.getUnlocalizedName() + "." + ItemCopperParts.names[i];
    }

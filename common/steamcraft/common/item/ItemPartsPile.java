...
public class ItemPartsPile extends ItemMod {
    public static final String[] names = new String[] { "0", "1", "2", "3"};
    @SideOnly(Side.CLIENT)
    private Icon[] icons;
    int number_parts = 4;

    public ItemPartsPile(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("pileParts");
    }
	...
	return super.getUnlocalizedName() + "." + ItemPartsPile.names[i];
    }

...
public class ItemSteelParts extends ItemMod {
    ...
    public ItemSteelParts(final int id) {
	super(id);
	setHasSubtypes(true);
	setUnlocalizedName("partsSteel");
    }
	...
	return super.getUnlocalizedName() + "." + ItemSteelParts.names[i];
    }

 ...
 *
 */
package xyz.brassgoggledcoders.steamcraft.common.worldgen.trees;
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
	{
		...
		else
		{
			...
			for (int l2 = 0; l2 < l; ++l2)
			{
				...
				{
					this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_, InitBlocks.blockRedwoodLog,
							this.woodMetadata);
				}
				...
				if (l2 < (l - 1))
				{
					...
					{
						this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_, InitBlocks.blockRedwoodLog,
								this.woodMetadata);
					}
					...
					{
						this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_ + 1, InitBlocks.blockRedwoodLog,
								this.woodMetadata);
					}
				}
			}

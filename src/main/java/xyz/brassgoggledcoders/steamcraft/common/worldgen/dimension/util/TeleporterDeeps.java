 ...
 *
 */
package xyz.brassgoggledcoders.steamcraft.common.worldgen.dimension.util;
...
import xyz.brassgoggledcoders.steamcraft.common.worldgen.structure.WorldGenFissurePortal;
...
public class TeleporterDeeps extends Teleporter
{
	...
	public TeleporterDeeps(WorldServer par1WorldServer)
	{
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		if (d3 >= 0.0D)
		{
			...
			par1Entity.setLocationAndAngles(d8, d9 + 1, d4, par1Entity.rotationYaw, par1Entity.rotationPitch);
			return true;
		}
		else
		{

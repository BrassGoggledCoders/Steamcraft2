...
import xyz.brassgoggledcoders.steamcraft.common.config.ConfigBalance;
...
public class InitRecipes
{
	...
	private static void initMetalsRecipes()
	{
		...
		for (int meta = 0; meta < 8; meta++)
		{
			...
			GameRegistry
					.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMetalPlate, 2, meta), "XX", 'X', "block" + LibInfo.metals[meta]));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(InitBlocks.blockMetal, 1, meta),
					new ItemStack(InitBlocks.blockMetalPlate, 1, meta), new ItemStack(InitBlocks.blockMetalPlate, 1, meta)));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockRustyMetalPlate, 2, meta), "XX", 'X',
					new ItemStack(InitBlocks.blockRustyMetal, 1, meta)));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(InitBlocks.blockRustyMetal, 2, meta),
					new ItemStack(InitBlocks.blockRustyMetalPlate, 1, meta), new ItemStack(InitBlocks.blockRustyMetalPlate, 1, meta)));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMossyMetalPlate, 16, meta), "XX", 'X',
					new ItemStack(InitBlocks.blockMossyMetal, 1, meta)));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(InitBlocks.blockMossyMetal, 2, meta),
					new ItemStack(InitBlocks.blockMossyMetalPlate, 1, meta), new ItemStack(InitBlocks.blockMossyMetalPlate, 1, meta)));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMetalLattice, 16, meta), "X X", " B ", "X X", 'X',
					"ingot" + LibInfo.metals[meta], 'B', "block" + LibInfo.metals[meta]));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockRustyMetalLattice, 16, meta), "X X", " B ", "X X", 'X',
					"ingot" + LibInfo.metals[meta], 'B', new ItemStack(InitBlocks.blockRustyMetal, 1, meta)));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMossyMetalLattice, 16, meta), "X X", " B ", "X X", 'X',
					"ingot" + LibInfo.metals[meta], 'B', new ItemStack(InitBlocks.blockMossyMetal, 1, meta)));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMetalLattice, 16, meta + 8), "X X", " B ", "X X", 'X',
					"plate" + LibInfo.metals[meta], 'B', "block" + LibInfo.metals[meta]));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockRustyMetalLattice, 16, meta + 8), "X X", " B ", "X X", 'X',
					"plate" + LibInfo.metals[meta], 'B', new ItemStack(InitBlocks.blockRustyMetal, 1, meta)));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockMossyMetalLattice, 16, meta + 8), "X X", " B ", "X X", 'X',
					"plate" + LibInfo.metals[meta], 'B', new ItemStack(InitBlocks.blockMossyMetal, 1, meta)));
		}
		for (int i = 0; i < 6; i++)
		{
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockVanillaScaffold, 16, i), "P P", " P ", "P P", 'P',
					new ItemStack(Blocks.planks, 1, i)));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockVanillaScaffold, 16, i + 6), "S S", " S ", "S S", 'S',
					Items.stick, 'P', new ItemStack(Blocks.planks, 1, i)));
		}

		GameRegistry.addRecipe(new ItemStack(InitBlocks.blockVanillaLattice, 16, 0), "P P", " B ", "P P", 'P', Items.iron_ingot, 'B',
				Blocks.iron_block);
		GameRegistry.addRecipe(new ItemStack(InitBlocks.blockVanillaLattice, 16, 1), "P P", " B ", "P P", 'P', Items.gold_ingot, 'B',
				Blocks.gold_block);
		GameRegistry.addRecipe(new ItemStack(InitBlocks.blockVanillaLattice, 16, 0), "P P", " B ", "P P", 'P',
				new ItemStack(InitItems.itemVanillaSheet, 1, 0), 'B', Blocks.iron_block);
		GameRegistry.addRecipe(new ItemStack(InitBlocks.blockVanillaLattice, 16, 1), "P P", " B ", "P P", 'P',
				new ItemStack(InitItems.itemVanillaSheet, 1, 1), 'B', Blocks.gold_block);

		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 0), "P P", " P ", "P P", 'P', InitBlocks.blockRedwoodPlanks));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 6), "S S", " S ", "S S", 'S', Items.stick, 'P',
				InitBlocks.blockRedwoodPlanks));
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 1), "P P", " P ", "P P", 'P', InitBlocks.blockMangrovePlanks));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 7), "S S", " S ", "S S", 'S', Items.stick, 'P',
				InitBlocks.blockMangrovePlanks));
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 2), "P P", " P ", "P P", 'P', InitBlocks.blockWillowPlanks));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 8), "S S", " S ", "S S", 'S', Items.stick, 'P',
				InitBlocks.blockWillowPlanks));
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 3), "P P", " P ", "P P", 'P', InitBlocks.blockPetrifiedPlanks));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 9), "S S", " S ", "S S", 'S', Items.stick, 'P',
				InitBlocks.blockPetrifiedPlanks));
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 4), "P P", " P ", "P P", 'P', InitBlocks.blockPolishedPlanks));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockModScaffold, 16, 10), "S S", " S ", "S S", 'S', Items.stick, 'P',
				InitBlocks.blockPolishedPlanks));

 ...
 *
 */
package xyz.brassgoggledcoders.steamcraft.common.items.vanity;

import net.minecraft.client.model.ModelBase;
import net.minecraft.util.ResourceLocation;
import xyz.brassgoggledcoders.steamcraft.api.vanity.EnumVanityType;
import xyz.brassgoggledcoders.steamcraft.api.vanity.IVanityItem;
import xyz.brassgoggledcoders.steamcraft.client.renderers.models.ModelTopHat;

 ...
 *
 * File created @ [Apr 13, 2014, 2:20:19 PM]
 */
...
public class ModelCustomBox
{
	...
	{
		this.quadList[quadNum].vertPos[3].texPosX = (texCoordMinX / this.textureWidth);
		this.quadList[quadNum].vertPos[3].texPosY = (texCoordMinY / this.textureHeight);
		this.quadList[quadNum].vertPos[2].texPosX = (texCoordMaxX / this.textureWidth);
		this.quadList[quadNum].vertPos[2].texPosY = (texCoordMinY / this.textureHeight);
		this.quadList[quadNum].vertPos[1].texPosX = (texCoordMaxX / this.textureWidth);
		this.quadList[quadNum].vertPos[1].texPosY = (texCoordMaxY / this.textureHeight);
		this.quadList[quadNum].vertPos[0].texPosX = (texCoordMinX / this.textureWidth);
		this.quadList[quadNum].vertPos[0].texPosY = (texCoordMaxY / this.textureHeight);
	}
	...
	public void rotateQuad(int quadNum, int times)
	{
		...
		for (int i = 0; i < 4; i++)
		{
			texX[i] = this.quadList[quadNum].vertPos[i].texPosX;
			texY[i] = this.quadList[quadNum].vertPos[i].texPosY;
		}
		...
		for (int i = 0; i < 4; i++)
		{
			...
			this.quadList[quadNum].vertPos[i].texPosX = texX[target];
			this.quadList[quadNum].vertPos[i].texPosY = texY[target];
		}
	}

...
public class InitRecipes
{
	...
	private static void initBlockRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitBlocks.blockCapacitor), "CSC", "CJC", "W W", 'C', "ingotCastIron",
				'W', InitBlocks.blockCopperWire, 'S', InitItems.itemElectricJarLarge, 'J', InitItems.itemElectricJarHuge));

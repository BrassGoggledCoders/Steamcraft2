...
public class InitRecipes
{
	...
	private static void initGunRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemGunPart, 1, 5), " II", " II", "  I", 'I',
				"ingotCastIron"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemGunPart, 1, 6), "IGI", "GSG", "IGI", 'I', "plateBrass",
				'G', Blocks.glass_pane, 'S', "gemEmerald"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemGunPart, 1, 7), "IGI", "GSG", "IGI", 'I', "plateBrass",
				'G', "paneGlass", 'S', "gemDiamond"));
		GameRegistry.addRecipe(new ItemStack(InitItems.itemGunPart, 1, 8), "SSS", "SJS", "SSS", 'J',
				InitItems.itemElectricJarSmall, 'S', new ItemStack(InitItems.itemResource, 1, 2));
		if(!ConfigBalance.cheaperCoreRecipe)
			GameRegistry.addRecipe(new ItemStack(InitItems.itemGunPart, 1, 9), "SPS", "PNP", "SPS", 'S',
		...
		// Actual Guns
		GameRegistry.addRecipe(new ItemStack(InitItems.flintlockMusket), " FL", " B ", " S ", 'S',
		...
		GameRegistry.addRecipe(new ItemStack(InitItems.matchlockMusket), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 0), 'B', new ItemStack(InitItems.itemGunPart, 1, 1), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemMatch);
		GameRegistry.addRecipe(new ItemStack(InitItems.percussionCapMusket), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 0), 'B', new ItemStack(InitItems.itemGunPart, 1, 1), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemPercussionCap);
		GameRegistry.addRecipe(new ItemStack(InitItems.flintlockRifle), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 0), 'B', new ItemStack(InitItems.itemGunPart, 1, 2), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', Items.flint);
		GameRegistry.addRecipe(new ItemStack(InitItems.matchlockRifle), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 0), 'B', new ItemStack(InitItems.itemGunPart, 1, 2), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemMatch);
		GameRegistry.addRecipe(new ItemStack(InitItems.percussionCapRifle), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 0), 'B', new ItemStack(InitItems.itemGunPart, 1, 2), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemPercussionCap);
		GameRegistry.addRecipe(new ItemStack(InitItems.flintlockPistol), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 11), 'B', new ItemStack(InitItems.itemGunPart, 1, 10), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', Items.flint);
		GameRegistry.addRecipe(new ItemStack(InitItems.matchlockPistol), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 11), 'B', new ItemStack(InitItems.itemGunPart, 1, 10), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemMatch);
		GameRegistry.addRecipe(new ItemStack(InitItems.percussionCapPistol), " FL", " B ", " S ", 'S',
				new ItemStack(InitItems.itemGunPart, 1, 11), 'B', new ItemStack(InitItems.itemGunPart, 1, 10), 'L',
				new ItemStack(InitItems.itemGunPart, 1, 3), 'F', InitItems.itemPercussionCap);
		// Ammo
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemMusketBall, 4), "II", "II", 'I', "ingotIron"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemRifleBullet, 4), " S ", " C ", " G ", 'S',
				"ingotSteel", 'C', "plateBrass", 'G', Items.gunpowder));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemPercussionCap), "GG", "II", 'I', "ingotBrass", 'G',
				Items.gunpowder));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemRocket, 1, 1), " F ", "PTP", "PTP", 'F', Items.flint_and_steel,
				'P',
				"plateBrass", 'T', Blocks.tnt));
	...
	{
		// Drills
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.drillBase), "   ", "IGI", "III", 'I', "ingotSteel", 'G',
				"gearSteel"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.drillCore), " D ", "DDD", " B ", 'B', InitItems.drillBase,
				'D', "ingotAluminum"));
		...
		// Steam
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.swordSteam), "II ", "IP ", "CSC", 'I', "plateSteel", 'P',
				"ingotBrass", 'S', Items.stick, 'C', "partClockworkMechanism"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.pickaxeSteam), "IPI", "CSC", " I ", 'R', "partCastIronRod",
				'P', "ingotBrass", 'I', "ingotSteel", 'S', Items.stick, 'C', "partClockworkMechanism"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.shovelSteam), "CPC", " S ", " R ", 'R', "partCastIronRod",
				'P', "ingotBrass", 'I', "ingotSteel", 'S', Items.stick, 'C', "partClockworkMechanism"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.axeSteam), "PIC", "PRC", " R ", 'R', "partCastIronRod",
				'P', "ingotBrass", 'I', "ingotSteel", 'S', "stickWood", 'C', "partClockworkMechanism"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.hoeSteam), "PIC", " S ", " R ", 'R', "partCastIronRod",
				'P', "ingotBrass", 'I', "ingotSteel", 'S', Items.stick, 'C', "partClockworkMechanism"));
	...
	private static void initArmorRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemSteamWingpack), "LWL", "RBR", "SPS", 'P',
	...
	private static void initBlockRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemMachinePart, 1, 9), "CRC", "CRC", "WAW", 'C', "plateSteel",
		...
		GameRegistry.addShapedRecipe(new ItemStack(InitBlocks.blockUranium), "UUU", "UUU", "UUU", 'U',
	...
	{
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemAqualung), "LLI", "L L", "LLL", 'L',
				Items.leather, 'I', "ingotIron"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemClimbingSpikes), " L ", "I I", 'L',
				Items.leather_boots, 'I', "ingotIron"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemTank), "GGG", "GWG", "GGG", 'G',
				Blocks.glass_pane, 'W', Items.water_bucket));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemFlippers), " B ", "L L", 'L',
				Items.leather, 'B', Items.leather_boots));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemLegBraces), "PPP", "P P", "P P", 'P',
				"plateCopper"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemLifeVest), "W W", "WWW", "WWW", 'W',
				Blocks.wool));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemParachute), "WWW", "W W", "S S", 'W',
				Blocks.wool, 'S', Items.string));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemPistonBoots), "   ", "CBC", "P P", 'P',
				Blocks.piston, 'B', Items.leather_boots, 'C', "partClockworkMechanism"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemPistonPlating), "RPR", "PCP", "RPR", 'C',
				Items.iron_chestplate, 'P', Blocks.piston, 'R', Items.redstone));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemRollerSkates), "   ", " L ", "WRW", 'W',
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemSteelPlating), "SSS", "SSS", "SSS", 'S',
				"plateSteel"));
	...
	private static void initOtherRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemIronParts, 1, 0),
				" P ", "PIP", " P ", 'I', "ingotIron", 'P', "plateIron"));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemCanisterSteam, 1, InitItems.itemCanisterSteam.getMaxDamage()),
				"PPP", "GGG", "PPP", 'G', "paneGlass", 'P', "plateBrass"));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemHammer), "III", " H ", " C ", 'I', "ingotCastIron",
		...
		GameRegistry.addRecipe(new ItemStack(InitItems.itemTeacup), "B B", " B ", 'B', Items.clay);
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemSpyglass), "BGB", "W W", " G ", 'B', "ingotBrass", 'G',
				"paneGlass", 'W', "plankWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(InitItems.itemFieldManipulator, 4, 0), "BRB", "RER", "BRB", 'B', "nuggetBrass",
				'E',
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Items.dye, 8, 15), "powderPhosphorus", Items.wheat_seeds,
				"powderPhosphorus", Items.wheat_seeds));
	}

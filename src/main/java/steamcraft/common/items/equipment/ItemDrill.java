...
public class ItemDrill extends ItemCoreDrill {
	...
	public static final Block[] blocksEffectiveAgainst = new Block[] {
			...
			Blocks.grass, Blocks.gravel };
	
	/** The tool material. */
	protected ToolMaterial toolMaterial;

	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemCoreDrill#registerIcons(net.minecraft.client.renderer.texture.IIconRegister)
	 */
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IIconRegister icon) {
		this.itemIcon = icon.registerIcon(LibInfo.PREFIX + "tools/"
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase hitEntity,
		...
		hitEntity.attackEntityFrom(
				...
				(this.toolMaterial.getDamageVsEntity()));
	...
	public float getDigSpeed(ItemStack stack, Block block, int metadata) {
		return /* this.getEnergy(stack) != 0 && */this.canHarvestBlock(block,
				stack) ? this.getEfficiency() : 1.0F;
	}

...
public class ItemModTool extends BaseItem {
	...
	protected ItemModTool(float damage, ToolMaterial toolMat, Block[] blockArray) {
		...
		this.efficiencyOnProperMaterial = toolMat
	...
	/* (non-Javadoc)
	 * @see net.minecraft.item.Item#getDigSpeed(net.minecraft.item.ItemStack, net.minecraft.block.Block, int)
	 */
	@Override
		...
		for (int i = 0; i < blocksEffectiveAgainst.length; i++) {
			if (blocksEffectiveAgainst[i] == block) {
				if (this.toolMaterial == MaterialHelper.TOOL_STEAM) {
					return (efficiencyOnProperMaterial - (((float) stack
							.getItemDamage()) * 11 / 320));
				}
	...
	/* (non-Javadoc)
	 * @see net.minecraft.item.Item#hitEntity(net.minecraft.item.ItemStack, net.minecraft.entity.EntityLivingBase, net.minecraft.entity.EntityLivingBase)
	 */
	@Override
	public boolean hitEntity(ItemStack itemstack, EntityLivingBase living1,
	...
	/* (non-Javadoc)
	 * @see net.minecraft.item.Item#getIsRepairable(net.minecraft.item.ItemStack, net.minecraft.item.ItemStack)
	 */
	@Override
	...
	public Multimap getItemAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.attackDamage
				...
				field_111210_e, "Tool modifier", this.damageVsEntity, 0));
		return multimap;
	}

	/* (non-Javadoc)
	 * @see net.minecraft.item.Item#onBlockDestroyed(net.minecraft.item.ItemStack, net.minecraft.world.World, net.minecraft.block.Block, int, int, int, net.minecraft.entity.EntityLivingBase)
	 */
	@Override
	public boolean onBlockDestroyed(ItemStack stack, World p_150894_2_,
			Block p_150894_3_, int p_150894_4_, int p_150894_5_,
			int p_150894_6_, EntityLivingBase living) {
		/*
	...
	public ItemStack onItemRightClick(ItemStack stack, World world,
		...
		if (!world.isRemote) {
			if (toolMaterial == MaterialHelper.TOOL_STEAM) {
				...
				while (stack.getItemDamage() - repairAmount >= 0
		...
		while (i < 36) {
			...
			if ((mainInv[i] != null)
				...
				if (!(getDamage(new ItemStack(canister)) == 0)) {
					canister.drain(new ItemStack(canister), steamForRepair,
							true);

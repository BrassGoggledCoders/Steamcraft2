...
public class ItemModSword extends ItemModTool {
	...
	public float getDigSpeed(ItemStack stack, Block block, int metadata) {
		if (block == Blocks.web) {
			...
			return material != Material.plants && material != Material.vine
					...
					&& material != Material.leaves ? 1.0F : 1.5F;
		}
	}

	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#hitEntity(net.minecraft.item.ItemStack, net.minecraft.entity.EntityLivingBase, net.minecraft.entity.EntityLivingBase)
	 */
	@Override
	public boolean hitEntity(ItemStack stack, EntityLivingBase living1,
	...
	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#onBlockDestroyed(net.minecraft.item.ItemStack, net.minecraft.world.World, net.minecraft.block.Block, int, int, int, net.minecraft.entity.EntityLivingBase)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#onItemRightClick(net.minecraft.item.ItemStack, net.minecraft.world.World, net.minecraft.entity.player.EntityPlayer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#getItemEnchantability()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#getIsRepairable(net.minecraft.item.ItemStack, net.minecraft.item.ItemStack)
	 */
	@Override
	public boolean getIsRepairable(ItemStack stack1, ItemStack stack2) {
		Item item = stack2.getItem();
		return this.toolMaterial.func_150995_f() == item ? true : super
				.getIsRepairable(stack1, stack2);
	}

	/* (non-Javadoc)
	 * @see steamcraft.common.items.equipment.ItemModTool#getItemAttributeModifiers()
	 */
	...
	public Multimap getItemAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.attackDamage
				...
				field_111210_e, "Weapon modifier", this.weaponDamage, 0));
		return multimap;
	}
}
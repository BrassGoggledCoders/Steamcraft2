...
public class SteamcraftWorldGenerator implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int chunkX, int chunkZ) {
		...
		for (int chance = 0; chance < Config.borniteChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 0, random.nextInt(3), Block.stone.blockID).generate(world, random, borniteXCoord, borniteYCoord, borniteZCoord);
		}
		...
		for (int chance = 0; chance < Config.brimstoneChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 1, random.nextInt(3), Block.stone.blockID).generate(world, random, brimstoneXCoord, brimstoneYCoord, brimstoneZCoord);
		}
		}
		}
		...
		for (int chance = 0; chance < Config.phosphateChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 2, random.nextInt(3), Block.stone.blockID).generate(world, random, zincXCoord, zincYCoord, zincZCoord);
		}
		...
		for (int chance = 0; chance < Config.uraniumChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 3, random.nextInt(3), Block.stone.blockID).generate(world, random, uraniteXCoord, uraniteYCoord, uraniteZCoord);
		}
		}
		}
		...
		for (int chance = 0; chance < Config.aluminumChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 4, random.nextInt(3), Block.stone.blockID).generate(world, random, aluminumXCoord, aluminumYCoord, aluminumZCoord);
		}
		}
		...
		for (int chance = 0; chance < Config.copperChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 5, random.nextInt(3), Block.stone.blockID).generate(world, random, copperXCoord, copperYCoord, copperZCoord);
		}
		}
		...
		for (int chance = 0; chance < Config.tinChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 6, random.nextInt(3), Block.stone.blockID).generate(world, random, tinXCoord, tinYCoord, tinZCoord);
		}
		}
		...
		for (int chance = 0; chance < Config.zincChance; chance++) {
			...
			new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 7, random.nextInt(3), Block.stone.blockID).generate(world, random, zincXCoord, zincYCoord, zincZCoord);
		}
		}
		...
		for (int chance = 0; chance < Config.etheriumChance; chance++) {
			...
			//new SmartOreGeneration(ConfigBlocks.blockCustomOre.blockID, 8, random.nextInt(3), Block.stone.blockID).generate(world, random, etheriumXCoord, etheriumYCoord, etheriumZCoord);
		}
		}
	}

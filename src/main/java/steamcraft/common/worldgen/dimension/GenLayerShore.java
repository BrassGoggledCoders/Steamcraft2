...
public class GenLayerShore extends GenLayer
{
		...
		for(int i1 = 0; i1 < length; ++i1)
		{
			for(int j1 = 0; j1 < width; ++j1)
			{
				...
				if(landBiomeId == BiomeGenBase.mushroomIsland.biomeID)
				{
					...
					if(l1 != BiomeGenBase.ocean.biomeID && i2 != BiomeGenBase.ocean.biomeID && j2 != BiomeGenBase.ocean.biomeID
				...
				else if(landBiomeId != BiomeGenBase.extremeHills.biomeID && landBiomeId != BiomeGenBase.extremeHillsPlus.biomeID
						&& landBiomeId != BiomeGenBase.extremeHillsEdge.biomeID)
				{
					...
					{
						if(!isBiomeOceanic(landBiomeId) && landBiomeId != BiomeGenBase.ocean.biomeID
								&& landBiomeId != BiomeGenBase.deepOcean.biomeID && landBiomeId != BiomeGenBase.river.biomeID
	...
	{
		return BiomeGenBase.getBiome(p_151631_1_) != null && BiomeGenBase.getBiome(p_151631_1_).getBiomeClass() == BiomeGenJungle.class ? true

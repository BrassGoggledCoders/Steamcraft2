...
public class CompatabilityLayer
{
	...
	private static void registerOreDictionaryEntries()
	{
		...
		OreDictHelper.registerOreWithAlts(InitItems.itemResource, 1, "powderSulpher", "sulpher", "dustSulpher", "powderSulfur", "sulfur", "dustSulfer", "powderSulphur", "sulphur", "dustSulphur");

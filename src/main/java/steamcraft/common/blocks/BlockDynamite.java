...
public class BlockDynamite extends BaseBlock
{
	...
	{
		this.spawnTNT(p_149664_1_, p_149664_2_, p_149664_3_, p_149664_4_, p_149664_5_, (EntityLivingBase) null);
	}
	...
	{
		this.blockIcon = ir.registerIcon(ModInfo.PREFIX + "blockDynamite");
		this.iconTop = ir.registerIcon(ModInfo.PREFIX + "blockDynamiteTop");
	}

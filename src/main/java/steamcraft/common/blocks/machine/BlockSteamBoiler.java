...
public class BlockSteamBoiler extends BlockContainerMod {
	...
	public void registerBlockIcons(IIconRegister icon) {
		this.blockIcon = icon.registerIcon(LibInfo.PREFIX
				+ "blockSteamBoilerSide");
		this.iconFront = icon.registerIcon(LibInfo.PREFIX
				+ "blockSteamBoilerFrontInactive");
		this.iconFrontActive = icon.registerIcon(LibInfo.PREFIX
				+ "blockSteamBoilerFrontActive");
		this.iconTop = icon
				.registerIcon(LibInfo.PREFIX + "blockSteamBoilerTop");
	}
	...
	public boolean onBlockActivated(World world, int par2, int par3, int par4,
		...
		if (world.isRemote)
			...
			TileSteamBoiler tile = (TileSteamBoiler) world.getTileEntity(par2,
					par3, par4);
			...
			player.openGui(Steamcraft.instance, GuiIDs.GUI_ID_STEAM_BOILER,
	...
	/* (non-Javadoc)
	 * @see steamcraft.common.blocks.machine.BlockContainerMod#onBlockPlacedBy(net.minecraft.world.World, int, int, int, net.minecraft.entity.EntityLivingBase, net.minecraft.item.ItemStack)
	 */
	@Override

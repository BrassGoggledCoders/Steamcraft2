...
public class BlockCastIronRailing extends BaseBlock
{
    ...
    {
        return world.isSideSolid(x, y, z, dir.getOpposite(), false) || world.getBlock(x, y, z) instanceof BlockCastIronGate || world.getBlock(x, y, z) instanceof BlockCastIronFence || world.getBlock(x, y, z) instanceof BlockCastIronRailing;
    }
}

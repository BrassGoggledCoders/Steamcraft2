...
public class ModelCopperPipe extends ModelBase
{
	...
	{
		/*
		 * if(type == 0) { side3.render(f); }
		 * 
		 * if(type == 1) { side4.render(f); }
		 * 
		 * if(type == 2) { bottom.render(f); }
		 * 
		 * if(type == 3) { top.render(f); }
		 * 
		 * if(type == 4) { side2.render(f); }
		 * 
		 * if(type == 5) { side.render(f); } top.render(f);
		 */
		side3.render(f);
		side4.render(f);
		bottom.render(f);

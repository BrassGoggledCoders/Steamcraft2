...
public class ModelFleshGolem extends ModelBase
{
	...
	public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
	{
		...
		if(i > 0)
		{
			this.fleshGolemRightArm.rotateAngleX = -2.0F + (1.5F * this.func_78172_a(i - p_78086_4_, 10.0F));
			this.fleshGolemLeftArm.rotateAngleX = -2.0F + (1.5F * this.func_78172_a(i - p_78086_4_, 10.0F));
		}
		else
		{
